...
public class GemPolishingCategory implements IRecipeCategory<GemPolishingRecipe> {
    public static final ResourceLocation UID = ResourceLocation.fromNamespaceAndPath(MagiusWorldMod.MOD_ID, "gem_polishing");
    ...
    public Component getTitle() {
        return Component.translatable("block.magiusworldmod.gem_polishing_station");
    }
