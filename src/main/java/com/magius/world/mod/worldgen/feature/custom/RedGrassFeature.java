...
public class RedGrassFeature extends Feature<NoneFeatureConfiguration> {

    public RedGrassFeature(Codec<NoneFeatureConfiguration> codec) {
        super(codec);
    }
    ...
    public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
        ...
        for (int i = 0; i < 8; i++) {
            ...
            level.setBlock(pos, ModBlocks.RED_GRASS.get().defaultBlockState(), 2);
            placedAny = true;
        }
