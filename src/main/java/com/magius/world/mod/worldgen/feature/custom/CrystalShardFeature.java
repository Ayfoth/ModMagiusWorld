...
public class CrystalShardFeature extends Feature<NoneFeatureConfiguration> {

    public CrystalShardFeature(Codec<NoneFeatureConfiguration> codec) {
        super(codec);
    }
    ...
    public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            level.setBlock(pos, ModBlocks.CRYSTAL_SHARD.get().defaultBlockState(), 2);
            placedAny = true;
        }
