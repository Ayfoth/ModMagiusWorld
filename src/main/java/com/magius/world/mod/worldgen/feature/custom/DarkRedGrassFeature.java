...
public class DarkRedGrassFeature extends Feature<NoneFeatureConfiguration> {

    public DarkRedGrassFeature(Codec<NoneFeatureConfiguration> codec) {
        super(codec);
    }
    ...
    public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
        ...
        for (int i = 0; i < 8; i++) {
            ...
            level.setBlock(pos, ModBlocks.DARK_RED_GRASS.get().defaultBlockState(), 2);
            placedAny = true;
        }
