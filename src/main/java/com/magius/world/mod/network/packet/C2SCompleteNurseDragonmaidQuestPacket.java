...
public class C2SCompleteNurseDragonmaidQuestPacket {
    ...
    public C2SCompleteNurseDragonmaidQuestPacket() {
    }
    ...
    public static void handle(
            C2SCompleteNurseDragonmaidQuestPacket packet,
            ...
            QuestManager.get(player)
                    .ifPresent(data -> {
                        ...
                        player.sendSystemMessage(
                                Component.literal(
                                        "§aQuête terminée : §fUne invitée inattendue"
                                )
                        );
                    });
        });
