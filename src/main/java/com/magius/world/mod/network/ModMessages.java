...
public class ModMessages {
    ...
    public static void register() {
        ...
        INSTANCE.messageBuilder(
                ...
                .add();
        INSTANCE.messageBuilder(
                        C2SStartSwordsoulMoYeQuestPacket.class,
                        id()
                )
                .encoder(
                        C2SStartSwordsoulMoYeQuestPacket::encode
                )
                .decoder(
                        C2SStartSwordsoulMoYeQuestPacket::new
                )
                .consumerMainThread(
                        C2SStartSwordsoulMoYeQuestPacket::handle
                )
                .add();
        INSTANCE.messageBuilder(
                        C2SClaimSwordsoulMoYeQuestRewardPacket.class,
                        id()
                )
                .encoder(
                        C2SClaimSwordsoulMoYeQuestRewardPacket::encode
                )
                .decoder(
                        C2SClaimSwordsoulMoYeQuestRewardPacket::new
                )
                .consumerMainThread(
                        C2SClaimSwordsoulMoYeQuestRewardPacket::handle
                )
                .add();
        INSTANCE.messageBuilder(
                        S2COpenSwordsoulMoYeDialoguePacket.class,
                        id()
                )
                .encoder(
                        S2COpenSwordsoulMoYeDialoguePacket::encode
                )
                .decoder(
                        S2COpenSwordsoulMoYeDialoguePacket::new
                )
                .consumerMainThread(
                        S2COpenSwordsoulMoYeDialoguePacket::handle
                )
                .add();
        INSTANCE.messageBuilder(
                        C2SStartSwordsoulTaiaQuestPacket.class,
                        id()
                )
                .encoder(
                        C2SStartSwordsoulTaiaQuestPacket::encode
                )
                .decoder(
                        C2SStartSwordsoulTaiaQuestPacket::new
                )
                .consumerMainThread(
                        C2SStartSwordsoulTaiaQuestPacket::handle
                )
                .add();
        INSTANCE.messageBuilder(
                        C2SClaimSwordsoulTaiaQuestRewardPacket.class,
                        id()
                )
                .encoder(
                        C2SClaimSwordsoulTaiaQuestRewardPacket::encode
                )
                .decoder(
                        C2SClaimSwordsoulTaiaQuestRewardPacket::new
                )
                .consumerMainThread(
                        C2SClaimSwordsoulTaiaQuestRewardPacket::handle
                )
                .add();
        INSTANCE.messageBuilder(
                        S2COpenSwordsoulTaiaDialoguePacket.class,
                        id()
                )
                .encoder(
                        S2COpenSwordsoulTaiaDialoguePacket::encode
                )
                .decoder(
                        S2COpenSwordsoulTaiaDialoguePacket::new
                )
                .consumerMainThread(
