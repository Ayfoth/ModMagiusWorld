...
import com.magius.world.mod.item.ModArmorMaterials;
...
public class ModArmorItem extends ArmorItem {
    private static final Map<ArmorMaterial, MobEffectInstance[]> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, MobEffectInstance[]>())
                    .put(ModArmorMaterials.SAPPHIRE, new MobEffectInstance[]{
                            new MobEffectInstance(MobEffects.NIGHT_VISION, 200, 1,
                                    false,false, true)
                    })
                    .put(ModArmorMaterials.WITHER, new MobEffectInstance[]{
                    ...
                    .put(ModArmorMaterials.RUBIS, new MobEffectInstance[]{
                            new MobEffectInstance(MobEffects.FIRE_RESISTANCE, 1, 5,
                                    false, true, true)
                    })
                    .build();
