...
public class ModBoatItem extends Item {
    ...
    private Boat getBoat(Level pLevel, HitResult pHitResult) {
        return (Boat)(this.hasChest ? new ModChestBoatEntity(pLevel, pHitResult.getLocation().x,
                pHitResult.getLocation().y, pHitResult.getLocation().z) : new ModBoatEntity(pLevel,
